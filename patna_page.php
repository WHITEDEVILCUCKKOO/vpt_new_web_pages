...
<style>
  ...
  .vpa-page a{color:inherit;text-decoration:none;}
  ...
  .vpa-hero-tab-active{background:var(--vpa-orange);color:#fff;}
  ...
  .vpa-thumb img{max-width:100%;border-radius:6px;}
  .vpa-thumb-tag{font-weight:800;color:var(--vpa-navy);font-size:14px;letter-spacing:.05em;}
  .vpa-thumb-brand{font-weight:800;color:var(--vpa-orange);font-size:21px;margin:3px 0;}
  .vpa-thumb-sub{font-size:11px;letter-spacing:.15em;color:var(--vpa-muted);margin-bottom:13px;}
  .vpa-thumb-circle{width:120px;height:120px;margin:0 auto;border-radius:50%;background:radial-gradient(circle at 35% 30%,#f3c94a,#2b6fd6 55%,#12386e 100%);position:relative;}
  ...
  .vpa-brand-link::before{content:"↗ ";color:var(--vpa-orange);}

  .vpa-list{padding-left:18px;margin:0 0 16px;color:var(--vpa-muted);}
  .vpa-list-item{margin-bottom:6px;line-height:1.6;font-size:15.5px;}
  .vpa-list-item .vpa-strong{color:var(--vpa-ink);}
  ...
  .vpa-industry-icon{font-size:26px;display:block;margin-bottom:8px;}
  ...
  .vpa-why-col{flex:1.4;}
  .vpa-why-col-intro{margin-bottom:10px;}
  .vpa-why-box{
    flex:1;
  ...
  .vpa-accent{color:var(--vpa-orange);}
  ...
  .vpa-final-thoughts .vpa-h2{margin-top:0;}
  ...
  .vpa-video-sub{display:block;font-weight:400;opacity:.75;font-size:12px;margin-top:3px;}
  .vpa-play-btn{
    position:absolute;
    top:50%;left:50%;
  ...
  .vpa-textarea{resize:none;min-height:70px;}
  .vpa-phone-row{display:flex;gap:6px;}
  .vpa-phone-code{
    flex:0 0 64px;
    display:flex;align-items:center;justify-content:center;
    border:1px solid var(--vpa-line);
  ...
  .vpa-help-text{color:#c7cbe0;font-size:13px;line-height:1.5;margin-bottom:16px;}
  .vpa-help-actions{display:flex;gap:10px;}
  .vpa-help-action{
    flex:1;
    text-align:center;
    padding:10px 6px;
  ...
  .vpa-help-enquire{background:var(--vpa-orange);color:#fff;}
  .vpa-help-whatsapp{background:#25d366;color:#fff;}

  @media (max-width:900px){
    .vpa-page{flex-direction:column;}
    .vpa-right{position:static;width:100%;flex:none;}
    .vpa-top-grid{flex-direction:column;}
    .vpa-brand-cols{grid-template-columns:repeat(2,1fr);}
    .vpa-industries{grid-template-columns:repeat(3,1fr);}
    .vpa-why-grid{flex-direction:column;}
  }
</style>
</head>
<body>
...
<div class="vpa-page">
  ...
  <div class="vpa-left">
    ...
    <div class="vpa-hero-banner">
      ...
      <span class="vpa-hero-tab vpa-hero-tab-active">Armatures</span>
    </div>
